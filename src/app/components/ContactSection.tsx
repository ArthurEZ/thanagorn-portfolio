...
export default function ContactSection() {
  return (
    <section className="w-full min-h-screen flex flex-col justify-center items-center px-4 mobile:px-8 tablet:px-16 mb-16 py-20 bg-gradient-to-b from-white via-blue-50/60 to-orange-50/40 dark:from-black dark:via-gray-900/80 dark:to-gray-950/80 transition-all duration-700">
      <h2 className="text-5xl font-extrabold mb-4 bg-gradient-to-r from-blue-600 via-violet-500 to-orange-500 bg-clip-text text-transparent drop-shadow-lg text-center animate-fadein">Interesting ?</h2>
